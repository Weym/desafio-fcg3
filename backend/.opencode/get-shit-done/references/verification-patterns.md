...
**@/home/henry/Documents/programming/github/alphaEdTech/projetos/desafio-fcg3/src/backend/.opencode/get-shit-done/references/checkpoints.md** → `<automation_reference>` section
