...
```bash
# Get state snapshot
node "/home/henry/Documents/programming/github/alphaEdTech/projetos/desafio-fcg3/src/frontend/.opencode/get-shit-done/bin/gsd-tools.cjs" state json 2>/dev/null || echo "{}"
```
