...
async def test_lifespan_creates_http_client_with_service_token_header(
    ...
    fake_settings = SimpleNamespace(
        ...
        database_url="postgresql+asyncpg://postgres:test@localhost:5432/app",
        asyncpg_dsn="postgresql://postgres:test@localhost:5432/app",
    ...
    monkeypatch.setattr("mcp_server.lifespan.asyncpg.create_pool", create_pool)
    ...
    assert create_pool.await_args.kwargs["dsn"] == "postgresql://postgres:test@localhost:5432/app"
