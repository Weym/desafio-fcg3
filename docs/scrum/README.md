...
| 6 | **Sprint Planning** | [SPRINT-PLANNING.md](./SPRINT-PLANNING.md) | Planning das 4 sprints: goals, itens selecionados, capacidade, riscos, acordos do time — Sprint 4 CONCLUIDA |
| 7 | **Sprint Review & Retro** | [SPRINT-REVIEW-RETRO.md](./SPRINT-REVIEW-RETRO.md) | Review Sprint 1 (completa) + Review Sprint 2 (completa) + Review Sprint 3 (completa) + Retrospectiva (Start/Stop/Continue) + licoes aprendidas |
| 8 | **Daily Standup** | [DAILY-STANDUP.md](./DAILY-STANDUP.md) | Log completo das dailies da Sprint 3 (5 dias x 6 membros) + registro de impedimentos resolvidos |
...
| SP Entregues (v1.0 — Sprints 1+2) | 193 SP |
| SP Entregues (Sprint 3) | 38 SP |
| SP Entregues (Sprint 4) | 12 SP |
| Total SP Entregues | 233 (100%) |
| Tarefas totais | 118 |
| Commits no repositorio | 559 |
