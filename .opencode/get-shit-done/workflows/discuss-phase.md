...
@./desafio-fcg3/.opencode/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @./desafio-fcg3/.opencode/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
   prompt="First, read @./desafio-fcg3/.opencode/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @./desafio-fcg3/.opencode/get-shit-done/workflows/discuss-phase-power.md
