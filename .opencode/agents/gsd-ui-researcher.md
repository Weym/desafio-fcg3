...
Use template from `./desafio-fcg3/src/backend/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `./desafio-fcg3/src/backend/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "./desafio-fcg3/src/backend/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
