...
Reference full template: `./desafio-fcg3/src/backend/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `./desafio-fcg3/src/backend/.opencode/get-shit-done/templates/state.md`.
