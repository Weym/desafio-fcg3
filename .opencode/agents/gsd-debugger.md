...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ./desafio-fcg3/src/backend/.opencode
                  → checks ./desafio-fcg3/src/backend/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ./desafio-fcg3/src/backend/.opencode/get-shit-done
                  → writes to ./desafio-fcg3/src/backend/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "./desafio-fcg3/src/backend/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "./desafio-fcg3/src/backend/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "./desafio-fcg3/src/backend/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
